...
ActiveRecord::Schema.define(:version => 20091216060109) do
  ...
  add_foreign_key "bill_criteria", "bills", :name => "bill_criteria_bill_id_fk"
  add_foreign_key "bill_criteria", "reports", :name => "bill_criteria_report_id_fk"

  add_foreign_key "bills", "congresses", :name => "bills_congress_id_fk"
  ...
  add_foreign_key "representative_terms", "congresses", :name => "representative_terms_congress_id_fk"
  add_foreign_key "representative_terms", "politicians", :name => "representative_terms_politician_id_fk"

  add_foreign_key "rolls", "congresses", :name => "rolls_congress_id_fk"

  add_foreign_key "senate_terms", "congresses", :name => "senate_terms_congress_id_fk"
  add_foreign_key "senate_terms", "politicians", :name => "senate_terms_politician_id_fk"
