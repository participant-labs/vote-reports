...
class ApplicationController < ActionController::Base
  ...
  helper_method :current_user_session, :current_user, :report_path_components, :report_path, :report_follows_path, :report_score_path, :report_bill_criteria_path, :new_report_bill_amendment_criterion_path, :report_bill_amendment_criteria_path
  ...
  def new_report_bill_amendment_criterion_path(report, bill, params = {})
    new_polymorphic_path([report_path_components(report), bill, :amendment_criterion].flatten, params)
  end

  def report_bill_amendment_criteria_path(report, bill, params = {})
    polymorphic_path([report_path_components(report), bill, :amendment_criteria].flatten, params)
  end
